            ...
            <div className="main-container">
                <div className="container">
                    ...
                    <center className="header">
                        <input placeholder="Enter Task Here" autoComplete="false" id="input" type="text" name="task" value={input.task} onChange={onChange} /><button type="submit" className="add-btn"></button>
                    </center>
                    <hr />
                    <div className="body">
                        <ul>
